...
public class HerniPlan implements Subject {
    ...
    private void zalozProstoryHry() {
        ...
        Prostor taborTulaku = new Prostor("tabor_tulaku", "Tábor tuláků",
        ...
        Prostor doupeZla = new Prostor("doupe_zla", "Doupě zla",
        ...
        Prostor chladnePlaniny = new Prostor("chladne_planiny", "Chladné planiny",
        ...
        Prostor pohrebiste = new Prostor("pohrebiste", "Pohřebiště",
        ...
        Prostor krypta = new Prostor("krypta", "Krypta",
        ...
        Prostor kamennePole = new Prostor("kamenne_pole", "Kamenné pole",
        ...
        Prostor tristram = new Prostor("tristram", "Tristram",
        ...
        Prostor katedrala = new Prostor("katedrala", "Katedrála",
        ...
        Prostor katakomby = new Prostor("katakomby", "Katakomby",
        ...
        Vec mec = new Vec("meč", "meč", "Základní meč, který se dostává po dokončení tréninku", true, "mec.png");
        Vec mecHrdinu = new Vec(mecHrdinuFinal, "Meč hrdinů", "Hrdinský meč kdysi ukovaným nejlepším kouzelníkem z Katedrály.\n"
                + "\tBuď pyšný na to, že ho zrovna ty můžeš mít. Tu starou trosku zahoď ze svého inventáře, \n"
                + "\taby si mohl používat tento meč hrdinů", true, "mecHrdinu.png");
        Vec stitHrdinu = new Vec("štít_hrdinů", "Štít hrdinů",
                "Hrdinský magický štít s velkou mocí, jen opravdový hrdina může nosit tento štít, jsi opravdový hrdina?", true, "stitHrdinu.png");
        Vec vesta = new Vec(vestaFinal, "Kožená vesnická vesta","Kožená vesnická vesta", true, "vesta.png");
        Vec brneni = new Vec("brnění","Brnění", "Karbonové brnění nejvyšší kvality, stvořené z nejlepších \n"
                + "\tmateriálů západních bájných krajů, kde jsou lidé pracovitější a vzrůstem menší", true, "brneni.png");
        Vec zlato = new Vec("zlato", "Zlato", "třpitivé penízky",true, "zlato.png");
        Vec amuletBloodRaven = new Vec("amulet_přesnosti", "Amulet přesnosti",
                "Blyštivý amulet ze zlata s magickou schopností přidávání přesnosti do tvých ran", true, "amuletBloodRaven.png");
        Vec roztrhanaVesta = new Vec("roztrhana_vesta","Roztrhaná vesta", "Pravá kůže a hodně děr, tohle by ti určitě slušelo :P", true, "roztrhanaVesta.png");
        Vec magickyKamenMoci = new Vec("magický_kámen_moci", "Magický kámen moci", "Tento magický, pradávný kámen ti umožní vstup do starého a\n"
                + "zapomenutého města Tristram",true, "magickyKamenMoci.png");
        Vec poharVitezstvi = new Vec("pohár_vítězství","Pohár vítězství", "Zasloužené Vítězství statečný bojovníku!\n",true, "poharVitezstvi.png");
        // vytvoříme několiv věcí - NEPŘENOSITELNÉ
        Vec zidle = new Vec("židle", "Židle", "klasická židle", false, "zidle.png");
        Vec lavicka = new Vec("lavička","Lavička", "posaď se, ale neodnášej!", false, "lavicka.png");
        Vec kamen = new Vec("šutr","Kámen", "zakrvácený klasický šutr, kterých se tady válí spousty, tenhle ale je obří!", false, "kamen.png");
        Vec kosti = new Vec("kosti","Kosti", "fujky! Starý smradlavý kosti", false, "kosti.png");
        Vec knihovna = new Vec("knihovna","Knihovna", "Hmmm..tolik vědomostí a leží tady tak zbytečně!", false, "knihovna.png");
        Vec postel = new Vec("postel","Postel", "Tady muselo být uděláno tolik dětí!", false, "postel.png");
        ...
        //Vytvořím monstra
        Monstrum skret = new Monstrum("skřet","skret.png",
        ...
        Monstrum lucisnice = new Monstrum("temná_lučištnice","lucistnice.png",
                "Umřeš!\n" + "*Snaží se po tobě střílet, ale ty svou vytrénovanou obratností uhýbáš\n"
                        + "šípům jako profík*", "*ugh*\n",mecHrdinuFinal,vestaFinal,zlato);
        Monstrum bloodRaven = new Monstrum("bloodRaven","bloodRaven.png",
        ...
        Monstrum zombie = new Monstrum("zombie","zombie.png",
                "egggrrrhhhh\n", "*zvuk spadlých kostí*\n",mecHrdinuFinal,"amulet_přesnosti",roztrhanaVesta);
        Monstrum padlyDemonChampion = new Monstrum("padly_demon_champion","padlyDemonChampion.png",
        ...
        Monstrum griswold = new Monstrum("griswold","griswold.png",
                "Ghrrrr\n", "eghhhhhh\n",mecHrdinuFinal,"brnění",zlato);
        Monstrum andariel = new Monstrum("Andariel","andariel.png",
        ...
        Postava akara = new Postava("akara","cain.png",
        ...
        Postava flavie = new Postava("flavie", "cain.png",
                "Dávej pozor cizinče, tady už to začíná být nebezpečné\n",
                "Dávej pozor cizinče, tady už to začíná být nebezpečné\n",
                "Dávej pozor cizinče, tady už to začíná být nebezpečné\n",null);
        Postava deckardCain = new Postava("deckard_cain", "cain.png",
        ...
        Postava kashya = new Postava("kashya", "cain.png",
        ...
        Postava charsi = new Postava("charsie", "cain.png",
